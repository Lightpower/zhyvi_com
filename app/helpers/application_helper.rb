module ApplicationHelper
  ...
  def category_divs
    Category.all.map { |category|
      content_tag(:div, link_to(category[:name].mb_chars.upcase, articles_path({articles: {category_id: category[:id]}}), class: 'h'), class: 'category shadow', 'data-index' => category[:id])
